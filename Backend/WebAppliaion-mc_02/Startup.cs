    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                var file = Directory.GetFiles(Directory.GetCurrentDirectory() + "/obj/Debug/netcoreapp3.0");
                var dir = Directory.GetDirectories(Directory.GetCurrentDirectory()+ "/obj/Debug/netcoreapp3.0");
                //... and tell Swagger to use those XML comments.
                c.IncludeXmlComments("/app/obj/Debug/netcoreapp3.0/WebApplication-mc_02.xml");
            });
